                ...
                >
                    ...
                    <h6 class="fs-title">Medical Grant</h6>
                        ...
                        <div><br></br>
                            ...
                            <TextField InputProps={{ startAdornment: <InputAdornment position="start">Rs.</InputAdornment>}} label="Amount Needed" id='mgamountneeded' className ="required" type="number" value={userData['loanamountneeded']} onChange={(e) => setUserData({ ...userData, "loanamountneeded": e.target.value })} margin='normal' variant='standard' color="primary" /><br></br> <span id='emgamountneeded' className='text-danger' >  </span>
